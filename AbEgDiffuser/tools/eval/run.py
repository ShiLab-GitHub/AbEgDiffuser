...
from AbEgDiffuser.tools.eval.base import EvalTask, TaskScanner
from AbEgDiffuser.tools.eval.similarity import eval_similarity
from AbEgDiffuser.tools.eval.energy import eval_interface_energy
...
def dump_db(db: Mapping[str, EvalTask], path):
    ...
    for task in db.values():
        if 'abopt' in path and task.scores['aar'] >= 100.0:
