...
from AbEgDiffuser.modules.common.layers import clampped_one_hot
from AbEgDiffuser.modules.common.so3 import ApproxAngularDistribution, random_normal_so3, so3vec_to_rotation, rotation_to_so3vec
...
class PositionTransition(nn.Module):
    ...
    def denoise_from_p0(self, p_t, p_0, mask_generate, t):
        ...
        posterior_log_variance_clipped = self.var_sched.posterior_log_variance_clipped[t].view(-1, *(
                    nb_non_batch_dims * (1,)))
