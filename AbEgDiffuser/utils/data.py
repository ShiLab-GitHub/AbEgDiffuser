...
from AbEgDiffuser.utils.protein.constants import max_num_heavyatoms
...
class PaddingCollate(object):
    ...
    def __call__(self, data_list):
        ...
        for data in data_list:
            ...
            data_padded['block_lengths'] = torch.full_like(data_padded['aa'], max_num_heavyatoms)
            data_padded['lengths'] = len(data_padded['aa'])
